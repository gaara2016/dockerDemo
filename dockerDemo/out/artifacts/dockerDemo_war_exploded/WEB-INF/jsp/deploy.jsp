            ...
            <div class="col-xs-12 col-md-12 col-sm-12" style="margin-top:20px;padding-top:10px;background-color:#eee;box-shadow: 0px 0px 30px 5px #ddd;">
                ...
                <div class="col-md-12 col-sm-12" style="margin-top:20px;border-top:2px double #ccc;padding-top:10px;background-color:#eee;box-shadow: 0px 0px 30px 5px #ddd;">
                    ...
                    <form class="form-horizontal" id="image_deploy" action="/deployOperation" method="post" name="imagedeploy">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-3" style="padding-left:0px">
                                    <input type="submit" class="form-control" id="strategy1" name="deployButton" value="strategy_1" style="border-color: #3c763d;">
                                </div>
                                <div class="col-sm-3" style="padding-left:0px">
                                    <input type="submit" class="form-control" id="strategy2" name="deployButton" value="strategy_2" style="border-color: #3c763d;">
                                </div>
                                <div class="col-sm-3" style="padding-left:0px">
                                    <input type="submit" class="form-control" id="strategy3" name="deployButton" value="strategy_3" style="border-color: #3c763d;">
                                </div>
                        ...
                        <div class="form-group has-error" style="margin-bottom:50px">
                            <label class="col-sm-2 control-label" style="cursor: pointer;">删除镜像：</label>
                            <div class="col-sm-9">
                                <div class="col-sm-3" style="padding-left:0px">
                                    <input type="submit" class="form-control" id="delete" name="deployButton" value="delete all images">
                                </div>
