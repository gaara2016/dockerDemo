		    ...
		    <div class="col-xs-12 col-md-12 col-sm-12" style="margin-top:20px;padding-top:10px;background-color:#eee;box-shadow: 0px 0px 30px 5px #ddd;">
			    <div class="col-md-6 col-sm-6" style="border-right:2px double #ccc;">
                    <table class="table table-bordered table-striped" id="ip_tables" >
                        <thead>
                            <tr>
                                <th colspan="3" style="text-align:center;font-size:16px;background:#E6F3F6 url('../img/cell_blue.jpg') no-repeat;background-size:100%;">服务器列表</th>
                            </tr>
                            <!-- <tr>
                ...
                <div class="col-md-6 col-sm-6">
                    <table class="table table-bordered table-striped" id="image_tables" >
                        <thead>
                            <tr>
                                <th colspan="2" style="text-align:center;font-size:16p;background:#F5F5E7 url('../img/cell_yellow.jpg') no-repeat;background-size:100%">镜像列表</th>
                            </tr>
                            ...
                            <tr>
                                <th colspan="2" style="padding-right:5px">
                                    <div class="btn-group" style="width:100%">
                                        <button class="btn btn-default " onclick="checkall(this,'image')" style="width:50%;background-color:#F3E094;"><b>全选</b></button>
                                        <button class="btn btn-default" onclick="uncheckall(this,'image')" style="width:50%"><b>取消全选</b></button>
                                    </div>
                                </th>
                            </tr>
                        </thead>
                ...
                <div class="col-md-12 col-sm-12" style="margin-top:20px;border-top:2px double #ccc;padding-top:10px;background-color:#eee;box-shadow: 0px 0px 30px 5px #ddd;">
                    ...
                    <form class="form-horizontal" id="image_deploy" action="/deployOperation" method="post" name="imagedeploy">
                        ...
                        <div class="form-group has-warning" style="margin-bottom:50px">
                            <label class="col-sm-2 control-label" style="cursor: pointer;color: #3c763d;">开始部署：</label>
                            <div class="col-sm-9">
                                <div class="col-sm-3">
                                    <input type="submit" class="form-control" id="strategy1" name="deployButton1" style="border-color: #3c763d;" value="strategy_1" >
                                </div>
                                <div class="col-sm-3">
                                    <input type="submit" class="form-control" id="strategy2" name="deployButton2" style="border-color: #3c763d;" value="strategy_2" >
                                </div>
                                <div class="col-sm-3">
                                    <input type="submit" class="form-control" id="strategy3" name="deployButton3" style="border-color: #3c763d;" value="strategy_3" >
                                </div>
                                <div class="progress progress-striped active" style="border-radius:2px 10px 10px 2px;background-color:#fff;margin-top:5px">
                                    <div class="progress-bar progress-bar-success" role="progressbar"
                                         aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%;background-color:#a5b37e;border-radius:2px 10px 10px 2px;">
                                        <b>00%</b>
                                    </div>
                                </div>
                                <button class="btn btn-default" style="background-color:#dd7e6b;color:white;border-radius:8px" onclick="test()" ><b>点击测试</b></button> <span id="test_result"></span>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        function ipcheck(data,type){
            ...
            if(type=="ip"){
                ...
                $("#deploy_image").val(final_ip.substring(0,final_ip.length-1));
            }
        } 
